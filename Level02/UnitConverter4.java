...
public class UnitConverter4 {
    ...
    public static void main(String[] args) {
        ...
        double miles = UnitConverter4.convertKmToMiles(km);

        // Call the method to convert  miles to km
        double kilometer = UnitConverter4.convertMilesToKm(miles);

        // Call the method to convert meter to feet
        double m=km*1000;
        double feet = UnitConverter4.convertMeterToFeet(m);
        
        // Call the method to convert feet to meter
        double meter = UnitConverter4.convertFeetToMeter(feet);

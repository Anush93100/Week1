public class UnitConverter6 {
    ...
    public static void main(String[] args) {
        ...
        double fahrenheitToCelsius = UnitConverter6.convertFahrenheitToCelsius(fahrenheit);
        System.out.println(fahrenheit + " °F = " + fahrenheitToCelsius + " °C");

        // Converting Celsius to Fahrenheit
        double celsius = 37.0;
        double celsiusToFahrenheit = UnitConverter6.convertCelsiusToFahrenheit(celsius);
        System.out.println(celsius + " °C = " + celsiusToFahrenheit + " °F");

        // Converting pounds to kilograms
        double pounds = 150;
        double poundsToKilograms = UnitConverter6.convertPoundsToKilograms(pounds);
        System.out.println(pounds + " lbs = " + poundsToKilograms + " kg");

        // Converting kilograms to pounds
        double kilograms = 68;
        double kilogramsToPounds = UnitConverter6.convertKilogramsToPounds(kilograms);
        System.out.println(kilograms + " kg = " + kilogramsToPounds + " lbs");

        // Converting gallons to liters
        double gallons = 5;
        double gallonsToLiters = UnitConverter6.convertGallonsToLiters(gallons);
        System.out.println(gallons + " gallons = " + gallonsToLiters + " liters");

        // Converting liters to gallons
        double liters = 10;
        double litersToGallons = UnitConverter6.convertLitersToGallons(liters);

...
public class UnitConverter5 {
    ...
    public static void main(String[] args) {
        ...
        double metersToInches = UnitConverter5.convertMetersToInches(meters);
        System.out.println("Distance in inches: " + metersToInches);

        // Display value in centimeter
        double inchesToCm = UnitConverter5.convertInchesToCentimeters(metersToInches);
        System.out.println("Distance in centimeter: " + inchesToCm);

        // Display value in meter
        double inchesToMeters = UnitConverter5.convertInchesToMeters(metersToInches);
        System.out.println("Distance in meters: " + inchesToMeters);

        // Display value in yards
        double feetToYards = UnitConverter5.convertFeetToYards(metersToInches/12);
        System.out.println("Distance in yards: " + feetToYards);

        // Display value in feet
        double yardsToFeet = UnitConverter5.convertYardsToFeet(feetToYards);
